...
config :weather_application, WeatherApplicationWeb.Endpoint,
  ...
  secret_key_base: "KKiksiTl90y7C1fcXRkUDz3gFzbwpp/wJKc3ny0/eXVCjFLPYhMi3RivC6F81EZA",
  server: false

# In test we don't send emails.
config :weather_application, WeatherApplication.Mailer, adapter: Swoosh.Adapters.Test
